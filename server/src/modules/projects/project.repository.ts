...
import { createProjectInput, updateProjectInput, IProjectImg } from '@modules/projects';

export const projectRepository = {
    create: async (userId: string, data: createProjectInput, imgData?: IProjectImg): Promise<Project> => {
    ...
    update: async (id: string, userId: string, data: updateProjectInput, imgData?: IProjectImg): Promise<Project> => {
